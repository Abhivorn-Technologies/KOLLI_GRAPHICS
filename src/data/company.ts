...
export const COMPANY_INFO: CompanyInfo = {
  ...
  mission: 'We are full committed service oriented premier finishing company to provide high quality craftsmanship and service in the timely manner. We stand by this and work tirelessly to stand above our competitors to ensure that we meet your deadlines & deliver products that exceed customers’ expectations.',
...
export const MANUFACTURING_ROLES = [
  {
    ...
    description: 'Hiring the most experienced staff of pre-press professionals to guarantee color-accurate, high-fidelity reproduction from initial digital artwork.',
    badge: 'Pre-Press & Color Calibration'
  },
  {
    title: 'Offset & UV Press Masters',
    description: 'Master operators commanding our Heidelberg CD 102 5 XL and Komori Lithrone 40 6-color presses with dual coating and full UV capability.',
    badge: 'Precision Lithography'
  },
  {
    title: 'BOBST Die-Cutting & Foiling Crew',
    description: 'Specialists operating BOBST SP Evoline 102 E, 102 BMA, and automatic stripping die-cutters to deliver crisp, perfectly flat blanks.',
    badge: 'Finishing & Converting'
  },
  {
    title: 'Quality Assurance & Inspection Team',
    description: 'Enforcing 100% optical inspection with Tubescan (<0.5mm defect detection) and online pasting inspection for zero-error delivery.',
