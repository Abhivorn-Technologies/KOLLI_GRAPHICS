...
import { Phone, Mail, MapPin, Building, Factory, ExternalLink, Send, CheckCircle2 } from 'lucide-react';
    ...
    <section id="contact" style={{ padding: '100px 0', backgroundColor: '#ffffff' }}>
      <div className="container">
        ...
        <SectionHeader
          ...
          badgeVariant="cyan"
          title="CONTACT"
          subtitle="Corporate Office, Works Facility & Direct Contact Form."
        />
        ...
        >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
                ...
                <div>
                  ...
                  <span style={{ fontSize: '0.78rem', color: '#6b7280' }}>Manufacturing & Secured Storage Facility</span>
                </div>
              </div>

              <p style={{ fontSize: '1rem', color: '#374151', lineHeight: 1.7, fontWeight: 500, marginBottom: '20px' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.95rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <a href={`tel:${COMPANY_INFO.phone}`} style={{ color: '#dc2626', fontWeight: 600 }}>
                    {COMPANY_INFO.phone}
                  </a>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <Mail size={16} color="#dc2626" />
                  <a href={`mailto:${COMPANY_INFO.email}`} style={{ color: '#dc2626', fontWeight: 600 }}>
                    {COMPANY_INFO.email}
                  </a>
                </div>
              </div>
          ...
          >
            <div style={{ marginBottom: '22px' }}>
              ...
              <h3 style={{ fontSize: '1.6rem', color: '#111827' }}>
                Contact Form:
              </h3>
            ...
            {submitted && (
              ...
              >
                ...
                <span>Thank you! Your message has been prepared for Ranga Reddy Kolli (+91 {COMPANY_INFO.phone}).</span>
              </div>
            )}
          </div>
        </div>
